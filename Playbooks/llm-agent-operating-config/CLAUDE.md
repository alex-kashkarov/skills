# CLAUDE.md — Global Behavior

<!-- Install as ~/.claude/CLAUDE.md (global) or in a project root (per-project).
     This file is behavior only — keep project facts in your own memory or context files. -->
